...
<template>
    <div class="mt-12">
        <form class="max-w-md mx-auto p-4 bg-slate-300 shadow-md rounded-md" @submit.prevent="updateTask($route.params.id)">
            <div class="space-y-6">
                <div class="mb-6">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="description" v-model="task.description" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div class="mt-4">
                    <button type="submit" class="px-4 py-2 mr-4 bg-indigo-500 hover:bg-indigo-800 rounded text-white">Update</button>
                </div>
            </div>
        </form>
    </div>
